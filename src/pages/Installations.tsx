...
import { 
  Plus, Search, ArrowLeft, Zap, Calendar, MapPin, 
...
const statusConfig = {
  ...
  inspection: { label: "Vistoria", color: "bg-orange-500", icon: User },
      ...
      <div className="container pb-8">
        <div className="grid gap-4">
          {filteredInstallations.map((inst) => {
            const status = statusConfig[inst.status as keyof typeof statusConfig];
